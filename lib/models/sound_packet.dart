...
// const String url = 'ws://192.168.100.50:8000/ws';
...
//     channel.stream.listen((event) async {
//       print('Event: $event');
//       Map<String, dynamic> audioPacket = jsonDecode(event.data.toString());
//       Uint8List.fromList(
//         base64Decode(
//           (audioPacket["data"].toString()),
//         ),
//       );
...
//     _audioStream = _recorder.audioStream.listen((data) {
//       final soundPacket = SoundPacket.fromJson(
//           jsonEncode(data) as Map<String, dynamic>);
//       // print(soundPacket.data);
//       channel.sink.add(SoundPacket(data: data).toJson().toString());
//       print('Data: $data');
//     });
